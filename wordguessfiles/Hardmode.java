...
public class Hardmode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(v -> {
            Intent mainIntent = new Intent(Hardmode.this, MainActivity.class);
    ...
    private void displayWinMessage() {
        ...
        Intent hardIntent = new Intent(Hardmode.this, Winactivity.class);
    ...
    private void displayLossMessage() {
        ...
        Intent loseIntent = new Intent(Hardmode.this, Loseactivity.class);
