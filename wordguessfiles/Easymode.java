...
public class Easymode extends AppCompatActivity {
    ...
    private static final String PREFS_NAME_EASY = "WordGuessPrefsEasy";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(v -> {
            Intent easyintent = new Intent(Easymode.this, MainActivity.class);
    ...
    private void saveHighScoreEasy() {
        SharedPreferences preferences = getSharedPreferences(PREFS_NAME_EASY, MODE_PRIVATE);
        SharedPreferences.Editor editor = preferences.edit();
        editor.putInt(KEY_HIGHEST_STREAK_EASY, highestStreak);
        editor.apply();
    }

    private void loadHighScoreEasy() {
        SharedPreferences preferences = getSharedPreferences(PREFS_NAME_EASY, MODE_PRIVATE);
        highestStreak = preferences.getInt(KEY_HIGHEST_STREAK_EASY, 0);
        updateStreakLabels();
    }
    ...
    private void displayWinMessage() {
        ...
        Intent easyintent = new Intent(Easymode.this, Winactivity.class);
        easyintent.putExtra("currentStreak", currentStreak);
        easyintent.putExtra("highestStreak", highestStreak);
        easyintent.putExtra("gameMode", "easy");
        startActivity(easyintent);
        finish();
    }
    ...
    private void displayLossMessage() {
        ...
        Intent loseIntent = new Intent(Easymode.this, Loseactivity.class);
        loseIntent.putExtra("currentStreak", currentStreak);
        loseIntent.putExtra("highestStreak", highestStreak);
        loseIntent.putExtra("gameMode", "easy");
