...
public class Normalmode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(v -> {
            Intent mainIntent = new Intent(Normalmode.this, MainActivity.class);
    ...
    private void displayWinMessage() {
        ...
        Intent normalIntent = new Intent(Normalmode.this, Winactivity.class);
    ...
    private void displayLossMessage() {
        ...
        Intent loseIntent = new Intent(Normalmode.this, Loseactivity.class);
